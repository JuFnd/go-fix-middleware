...
func GetApi(c *usecase.Core, l *slog.Logger, cfg *configs.DbDsnCfg) *API {
	...
	mx.Handle("/api/v1/films", api.mw.GetResponse(http.HandlerFunc(api.Films), l))
	mx.Handle("/api/v1/film", api.mw.GetResponse(http.HandlerFunc(api.Film), l))
	mx.Handle("/api/v1/actor", api.mw.GetResponse(http.HandlerFunc(api.Actor), l))
	mx.Handle("/api/v1/favorite/films", api.mw.GetResponse(http.HandlerFunc(api.FavoriteFilms), l))
	mx.Handle("/api/v1/favorite/film/add", api.mw.GetResponse(http.HandlerFunc(api.FavoriteFilmsAdd), l))
	mx.Handle("/api/v1/favorite/film/remove", api.mw.GetResponse(http.HandlerFunc(api.FavoriteFilmsRemove), l))
	mx.Handle("/api/v1/favorite/actors", api.mw.GetResponse(http.HandlerFunc(api.FavoriteActors), l))
	mx.Handle("/api/v1/favorite/actor/add", api.mw.GetResponse(http.HandlerFunc(api.FavoriteActorsAdd), l))
	mx.Handle("/api/v1/favorite/actor/remove", api.mw.GetResponse(http.HandlerFunc(api.FavoriteActorsRemove), l))
	mx.Handle("/api/v1/find", api.mw.GetResponse(http.HandlerFunc(api.FindFilm), l))
	mx.Handle("/api/v1/search/actor", api.mw.GetResponse(http.HandlerFunc(api.FindActor), l))
	mx.Handle("/api/v1/calendar", api.mw.GetResponse(http.HandlerFunc(api.Calendar), l))
	mx.Handle("/api/v1/rating/add", api.mw.GetResponse(http.HandlerFunc(api.AddRating), l))
	mx.Handle("/api/v1/add/film", api.mw.GetResponse(http.HandlerFunc(api.AddFilm), l))
